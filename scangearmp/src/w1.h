...
#define	STR_ABOUT_VER		"Ver.1.60"
#define	STR_ABOUT_LINUX		" for Linux"
#define	STR_ABOUT_CR		"Copyright "
#define	STR_ABOUT_AUTHOR	"CANON INC. "
#define	STR_ABOUT_YEAR		"2007-2010"
...
CNMSVoid W1_ModalDialogShowAction( GtkWidget *widget );
CNMSVoid W1_ModalDialogHideAction( GtkWidget *widget );
